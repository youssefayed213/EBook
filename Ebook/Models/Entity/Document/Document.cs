...
namespace Ebook.Models.Entity.Document
{
    public class Document
    {
        ...
        public Document(int id, string originalTitle, int editor, int collection, string doi, string marcRecordNumber, string titlesVariants, string subtitle, List<string> keywords, string file, string fileFormat, string coverPage, string url, string documentType, string originalLanguage, string languageVariants, string translator, string accessType, string state, float price, string publicationDate, string country, string physicalDescription, int volumeNb, string @abstract, string notes)
        {
            Id = id;
