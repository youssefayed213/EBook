        ...
        public static void CreateTable()
        {
            try
            {
                ...
                const string sql = "If not exists (select * from sysobjects where name = 'Author') " +
                                    "CREATE TABLE [dbo].[Collection] ( [Id] BIGINT IDENTITY(1, 1) NOT NULL, [Name] nvarchar(max)  NOT NULL, [Biography] nvarchar(max)  NULL, [Photo] nvarchar(max) DEFAULT('default.png') NOT NULL,CONSTRAINT [PK_Author] PRIMARY KEY CLUSTERED ([Id] ASC) );";
