...
namespace Ebook.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(IWebHostEnvironment webHostEnvironment, IToastNotification notification,
        ...
        public IActionResult Create(DocumentPurchaseVm model)
        {
            ...
            if (result.IsSuccess())
            {
                ...
                var operation = BllUser.UpdatePurchaseApi(model,User.FindFirst(ClaimTypes.Country).Value, _notification);
        ...
        [HttpGet]
        public IActionResult Download(string userid, string id)
        {
        ...
        [HttpGet]
        public IActionResult View(string userid, string id)
        {
            var operation = BllDocument.GetDocumentById("Id", id).DocumentGroup;
